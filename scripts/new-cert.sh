...
cp "$TEMPLATES_DIR/objectives-template.md" "$TARGET_DIR/objectives.md"
print_success "Created: objectives.md"

cp "$TEMPLATES_DIR/notes-template.md" "$TARGET_DIR/notes.md"
print_success "Created: notes.md"

cp "$TEMPLATES_DIR/quick-refresher-template.md" "$TARGET_DIR/quick-refresher.md"
print_success "Created: quick-refresher.md"
...
echo "     - index.md         (exam info, overview)"
echo "     - objectives.md    (exam domains)"
echo "     - notes.md         (study content)"
echo "     - quick-refresher.md (cram sheet)"
echo "     - exam-tips.md     (strategies)"
echo ""

...
description: "Traps, common pitfalls, and quick decision rules for the GH-900 exam"
head:
  - - meta
    - name: keywords
      content: gh-900, exam guide, exam traps, tips
---
...
The GH-900 exam is for **[target role]**. It values **[core principles]**.
...
```
[Condition 1] → [Service A]
[Condition 2] → [Service B]
[Condition 3] → [Service C]
```

...
description: "Study notes for GH-200 GitHub Actions certification exam"
head:
  - - meta
    - name: keywords
      content: gh-200, github actions, github, certification, exam, study notes, ci/cd
---
...
<ProgressTracker
  title="GitHub Actions Study Progress"
  ...
  :items="[
    {
      ...
      children: [
        ...
        { id: 'domain-1-3', label: 'Jobs and steps' }
      ]
    },
    {
      id: 'domain-2',
      ...
      children: [
        ...
        { id: 'domain-2-3', label: 'Composite actions' }
      ]
    },
    {
      id: 'domain-3',
      ...
      children: [
        ...
        { id: 'domain-3-3', label: 'Publishing actions' }
      ]
    },
    {
      id: 'domain-4',
      ...
      children: [
        ...
        { id: 'domain-4-3', label: 'Security best practices' }
      ]
    },
